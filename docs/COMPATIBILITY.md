...
| `android-clipboard-history` | format | `1` | exact encrypted v1 only; unknown future versions are preserved but hidden, while malformed current-v1 ciphertext or payload is cleared fail closed | backup-excluded private AES-256-GCM payload; at most 100 distinct entries and 120,000 code points; no plaintext fallback or downgrade writer | `android/app/src/main/java/com/opentypeless/android/keyboard/clipboard/ClipboardHistoryCodec.java`, `android/app/src/main/java/com/opentypeless/android/keyboard/clipboard/ClipboardHistoryStore.java`, `android/app/src/main/java/com/opentypeless/android/security/LocalClipboardCipher.java` | `KBD-011` |
