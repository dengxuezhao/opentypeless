...
TRUSTED_POLICY_CANONICAL_SHA256 = "a5eb7f1d102b39290efd3791e741b8e5b3e28a959d601922e40719653378cbfc"
...
def _validate_policy(value: dict[str, object]) -> Contract:
    ...
    if not isinstance(raw_expectations, list) or len(raw_expectations) != 111:
        raise PolicyError("artifact expectations must contain the exact 111 reviewed APKs")
    expectation_keys = {
